...
const DEFAULT_LAUNCH_DEMO_PACKAGE_SPEC = "github:proof-computer/switchboard-express-demo#v0.2.4";
const MIN_LAUNCH_DEMO_RUNTIME_VERSION = "0.2.4";
const MIN_LAUNCH_DEMO_RUNTIME_PACKAGE_VERSION = "0.1.4";
