...
export default class SwitchboardLease extends Command {
  ...
  static examples = [
    "<%= config.bin %> switchboard lease --target proof-ingress-local --broker-id 0 --route-class-id 42 --hostname app.example.com --lease-epochs 10 --polkadot-seed //Alice --yes --json"
  ];
  static strict = false;
  static flags = {
